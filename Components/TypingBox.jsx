...
const TypingBox = () => {
  ...
  const handleUserInput = (e) => {
    ...
    if (e.keyCode === 32) {
      //logic for space
      const correctSpans =wordSpanRef[currWordIndex].current.querySelectorAll(".correct"); //get out all spans with correct classname

      if (correctSpans.length === allCurrChars.length) {
